...
tb_interventions_timeline <- data_frame(year = c(1921, 1944, 1944, 1952, 1952, 1953, 1962, 1971, 1995, 2005, 2012),
                                  ...
                                  detail = c("The first use of the Bacillus Calmette–Guérin (BCG) vaccine in humans, it remains the only vaccine against Tuberculosis (tb). 
                                            ...
                                            "The first antibiotic and the first bacterial agent against TB.",
                                             ...
                                             for the vaccine, BCG was introduced for those at school leaving age
                                             ...
                                             "The first new antiobiotic for use against TB in 40 years, reserved for use against multiple drug resistant TB. Approved via a fast track process there
                                             is still significant concern due to higher mortality in those that recieve the antibiotic."))
