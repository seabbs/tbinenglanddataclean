...
if (!file.exists("~/data/tbinenglanddataclean/england_births.rds") || rebuild) {
  clean_and_munge_england_births(birth_path = "~/data/UK_demographics/annual_reference_table.xls",
...
if (!file.exists("~/data/tbinenglanddataclean/england_mortality_rate.rds") || rebuild) {
clean_and_munge_england_life_expectancy(life_tables_path = "~/data/UK_demographics/england_life_tables.xls",
